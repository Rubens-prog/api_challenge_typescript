...
export class Default1697919876766 implements MigrationInterface {
    name = 'Default1697919876766'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "contacts_deals" ("contact_id" integer NOT NULL, "deal_id" integer NOT NULL, CONSTRAINT "PK_6e40eac5a474e15869898e8a370" PRIMARY KEY ("contact_id", "deal_id"))`);
        ...
        await queryRunner.query(`ALTER TABLE "contacts_deals" ADD CONSTRAINT "FK_e6019da848cb332199176fd3627" FOREIGN KEY ("contact_id") REFERENCES "deals"("id") ON DELETE CASCADE ON UPDATE CASCADE`);
        await queryRunner.query(`ALTER TABLE "contacts_deals" ADD CONSTRAINT "FK_d873ec8496f691a8cf6deff604c" FOREIGN KEY ("deal_id") REFERENCES "contacts"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
